...
function build_aprobacion_snapshot(){
  ...
  const comision = __parseMontoToNumber(($("#comision").val() || "").trim());
    ...
    const KEY = "aprobacion_inst_corto_plazo_bcrp";
 ...
 * Key: "aprobacion_inst_corto_plazo_bcrp"
 */
 ...
 * Lee de localStorage clave "aprobacion_inst_corto_plazo_bcrp".
 * Reglas:
...
function __getListaAprobacion(KEY = "aprobacion_inst_corto_plazo_bcrp"){
  let lista;
  try { lista = JSON.parse(localStorage.getItem(KEY) || "[]"); }
  catch { lista = []; }
