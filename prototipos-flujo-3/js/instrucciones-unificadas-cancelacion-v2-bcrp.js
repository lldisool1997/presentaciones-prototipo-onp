 ...
 * Key: "cancelacion_inst_corto_plazo_bcrp"
 */
function aprobacion_inst_corto_plazo(){
  try {
    const KEY = "cancelacion_inst_corto_plazo_bcrp";
 ...
 * Lee de localStorage clave "cancelacion_inst_corto_plazo_bcrp".
 * Reglas:
...
function __getListaAprobacion(KEY = "cancelacion_inst_corto_plazo_bcrp"){
  let lista;
  try { lista = JSON.parse(localStorage.getItem(KEY) || "[]"); }
  catch { lista = []; }
